...
//private
internal fun DrawScope.drawCircleWithShadow(
	position: Offset,
	touched: Boolean,
...
//private
internal fun <T> DrawScope.drawStepMarkersAndLabels(
	steps: List<T>,
...
//private
internal fun calculateStepCoordinatesAndSpacing(
	numberOfSteps: Int,
	barXStart: Float,
	barWidth: Float,
...
@Composable
//private -> to public
internal fun <T> Pair<IntSize, Density>.derive(additionalKey: Any? = null, block: Density.() -> T): T =
